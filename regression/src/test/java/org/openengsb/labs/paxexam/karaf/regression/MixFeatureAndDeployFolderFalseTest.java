...
public class MixFeatureAndDeployFolderFalseTest {
    ...
    public Option[] config() {
        return new Option[]{
            ...
            editConfigurationFilePut(
                FeaturesCfg.BOOT,
                "karaf-framework,config,activemq-broker,activemq-spring,cxf-specs,camel,camel-activemq,camel-cxf,camel-blueprint"),
    ...
    public void test() throws Exception {
        assertFalse(featuresService.isInstalled(featuresService.getFeature("war")));
